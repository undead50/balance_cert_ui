...
import { Form, Input, DatePicker, Button, Table, Row, Col, Card ,Space,Modal, Descriptions} from 'antd';
import { useDispatch, useSelector } from 'react-redux';
import { fetchCertificatesAsync, resetStateCertificate } from '../../store/slices/certificateSlice';
...
const Step1Form = () => {
    ...
    const columns = [
        { title: 'SOL_ID_CERTIFICATE_ISSUE', dataIndex: 'SOL_ID_CERTIFICATE_ISSUE', key: 'SOL_ID_CERTIFICATE_ISSUE' },
        { title: 'REFERENCE_NO', dataIndex: 'REFERENCE_NO', key: 'REFERENCE_NO' },
        { title: 'CERT_ISSUING_BRANCH', dataIndex: 'CERT_ISSUING_BRANCH', key: 'CERT_ISSUING_BRANCH' },
        { title: 'ACCOUNTNUMBER', dataIndex: 'ACCOUNTNUMBER', key: 'ACCOUNTNUMBER' },
        { title: 'ACCOUNT_SOL_ID', dataIndex: 'ACCOUNT_SOL_ID', key: 'ACCOUNT_SOL_ID' }, {
            title: 'Action',
            key: 'action',
            render: (_, record) => (
                <Space size="middle">
    ...
    return (
        <Card>
            ...
            <Table
                ...
                columns={columns}
            />
            <Modal title="Certificate Details" width={600} open={isModalVisible} onOk={handleOk} onCancel={handleCancel}>
